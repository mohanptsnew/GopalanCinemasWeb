...
public void Page_Load(object sender, EventArgs e)
  {
		...
		{				
			...
			{		
            //if (strResponceIP != "27.34.247.6" && strResponceIP != "27.34.247.6")
			//{		
					...
					*/
                Response.Write("REDIRECT=http://27.34.247.6/FailedTRAN.aspx?Message=--IP MISSMATCH-- Response IP Address is: " + strResponceIP);
			}
			else
			{
...
//====================================================================================================================================	
					...
					if (ResErrorNo == null)
					{
							...
							if (ResResult=="CAPTURED" || ResResult=="APPROVED")//If resulr is CAPTURED or APPROVED then below Code is execute for dual inquiry 
							{
                                ...
                                string ReqTranportalId = "<id>90002237</id>";
									 ...
									 using (System.IO.StreamReader sr =new System.IO.StreamReader(objResponse.GetResponseStream()))
										{
													...
													if (INQCheck[0]=="CAPTURED" || INQCheck[0]=="APPROVED")
													{
														...
														*/
                                                        ...
                                                        Response.Write("REDIRECT=http://27.34.247.6/StatusTRAN.aspx?ResResult=Transaction Success [" + INQResResult[0] + "]&ResTrackId=" + INQResTrackId[0] + "&ResAmount=" + INQResAmount[0]);														
													}
													else
													{
														/*
														...
														AND THEN REDIRECT CUSTOMER ON RESULT PAGE
														*/
                                                        Response.Write("REDIRECT=http://27.34.247.6/FailedTRAN.aspx?Message=Transaction Failed&ResTrackId=" + ResTrackID + "&ResAmount=" + ResAmount + "&ResError=" + INQCheck[0]);
													}
										}
