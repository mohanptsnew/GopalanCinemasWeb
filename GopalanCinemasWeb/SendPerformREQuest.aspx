...
<head runat="server">
    <title>Demo pages for Hosted ASP.net pages</title>
...
{   
		try
		{
            ...
            string ReqTranportalId = "id=" + "90002237" + "&";
            ...
            string ReqResponseUrl = "responseURL=" + "http://27.34.247.6/GetHandleRESponse.aspx" + "&";
			...
			*/
            string ReqErrorUrl = "errorURL=" + "http://27.34.247.6/FailedTRAN.aspx" + "&";
			...
			are not utilized */
			string ReqUdf1 = "udf1="+"mohan.pts@gmail.com"+"&";		// UDF1 values                                                                
			string ReqUdf2 = "udf2="+"Annanagar"+"&";		// UDF2 values 	                                                               
			string ReqUdf3 = "udf3="+"18thMainRoad"+"&";	 	// UDF3 values                                                             
			string ReqUdf4 = "udf4="+"Chennai"+"&";	 	// UDF4 values                                                                
			string ReqUdf5 = "udf5="+"India"+"&";		// UDF5 values 
           ...
           Response.Write(objResponse.ToString());
           Response.End();
           using (System.IO.StreamReader sr =new System.IO.StreamReader(objResponse.GetResponseStream()))
                {
					...
					{
                        string TranErrorUrl = "http://27.34.247.6/FailedTRAN.aspx?Message=Transaction Failed&ResTrackId=" + TranTrackid + "&ResAmount=" + TranAmount + "&ResError=" + TranResponse;
